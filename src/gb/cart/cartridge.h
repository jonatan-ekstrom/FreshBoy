...
class Cartridge_ {
public:
    static Cartridge Create(const std::filesystem::path& romPath, uint refreshRate);
    ...
    virtual void LoadRam(const std::filesystem::path& ramPath);
    virtual void SaveRam(const std::filesystem::path& ramPath);
protected:
